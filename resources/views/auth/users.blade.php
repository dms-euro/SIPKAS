    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2" data-aos="fade-up" data-aos-delay="100">
            <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl shadow-green-500/10 border border-white/50 p-8">
                ...
                <div class="flex items-center mb-8">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                        <i class="ri-user-add-line text-white text-2xl"></i>
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Form Tambah User Baru</h2>
                ...
                <form action="{{ route('adduser') }}" method="POST" id="userRegistrationForm" class="space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    <i
                                        class="ri-user-line absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl"></i>
                                    <input type="text" id="name" name="name" required
                                        class="w-full pl-12 pr-4 py-4 bg-white/80 backdrop-blur-sm border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-500/10 transition-all duration-300 outline-none font-medium"
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    <i
                                        class="ri-mail-line absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl"></i>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-green-500/5 to-emerald-600/5
                                        rounded-xl blur-sm group-focus-within:blur-0 transition-all duration-300">
                                </div>

                                <div class="relative">
                                    <i
                                        class="ri-shield-user-line absolute left-4 top-1/2 -translate-y-1/2
                                        text-gray-400 text-xl"></i>

                                    <select name="role" id="role" required
                                        class="w-full pl-12 pr-10 py-4 bg-white/80 backdrop-blur-sm
                                    ...
                                    <i
                                        class="ri-arrow-down-s-line absolute right-4 top-1/2 -translate-y-1/2
                                            text-gray-400 text-xl pointer-events-none"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    <i
                                        class="ri-lock-line absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl"></i>
                                    <input type="password" id="password" name="password" required
                                        class="w-full pl-12 pr-12 py-4 bg-white/80 backdrop-blur-sm border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-500/10 transition-all duration-300 outline-none font-medium"
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                        <button type="button" onclick="resetForm()"
                            class="flex-1 px-6 py-4 bg-white/60 backdrop-blur-sm border-2 border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-white hover:border-gray-300 transition-all duration-300 flex items-center justify-center shadow-md hover:shadow-lg">
                            <i class="ri-refresh-line mr-2 text-xl"></i>
                            Reset Form
                        </button>
        ...
        <div class="space-y-8" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl shadow-green-500/10 border border-white/50 p-6">
                ...
                <div class="space-y-4">
                    <div
                        class="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50/50 rounded-xl border border-green-100">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Total admin aktif</p>
                            </div>
                        </div>
                    ...
                    <div
                        class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50/50 rounded-xl border border-blue-100">
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                <i class="ri-team-line text-blue-600"></i>
                            </div>
                            <div>
                                <p class="font-bold text-gray-800">User Kelas</p>
                                <p class="text-sm text-gray-600">Total user kelas</p>
                            </div>
                        </div>
                        <div class="text-right">
                    ...
                    <div
                        class="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-50/50 rounded-xl border border-gray-100">
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mr-3">
                                <i class="ri-user-line text-gray-600"></i>
                            </div>
                            <div>
                                <p class="font-bold text-gray-800">Total User</p>
                                <p class="text-sm text-gray-600">Semua user aktif</p>
                            </div>
                        </div>
                        <div class="text-right">
            ...
            <!-- Quick Guide -->
            <div
                class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl shadow-green-500/50 p-6 text-white">
                ...
                <ul class="space-y-3 text-sm text-green-100">
                    <li class="flex items-start">
                        <i class="ri-checkbox-circle-line mt-0.5 mr-2 flex-shrink-0"></i>
                        <span>Verifikasi email user sebelum didaftarkan</span>
                    </li>
                    <li class="flex items-start">
                        <i class="ri-checkbox-circle-line mt-0.5 mr-2 flex-shrink-0"></i>
                        <span>Pilih role sesuai kebutuhan akses</span>
                    </li>
                    <li class="flex items-start">
                        <i class="ri-checkbox-circle-line mt-0.5 mr-2 flex-shrink-0"></i>
                        <span>Untuk user kelas, pilih kelas yang sesuai</span>
                    </li>
                </ul>
            </div>
        </div>
