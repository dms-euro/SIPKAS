        ...
        <div class="w-full max-w-6xl">
            <div class="grid lg:grid-cols-2 gap-0 lg:gap-8 items-center">
                ...
                <div class="hidden lg:block" data-aos="fade-right" data-aos-duration="1000">
                    <div
                        class="bg-gradient-to-br from-green-600 via-green-500 to-emerald-600 rounded-3xl p-12 shadow-2xl shadow-green-500/50 relative overflow-hidden">
                        <!-- Decorative elements -->
                        <div
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex items-center space-x-4 mb-12" data-aos="fade-down" data-aos-delay="200">
                                <div
                                    class="w-16 h-16 bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center border border-white/30 shadow-lg">
                                    <img src="{{ asset('images/logo_smp2.png') }}" alt="Logo SMP 2"
                                        class="w-full h-full object-contain">
                                </div>
                                <div>
                                    <h1 class="text-3xl font-bold text-white">Sipas</h1>
                            ...
                            <div class="mb-12" data-aos="fade-up" data-aos-delay="300">
                                <h2 class="text-4xl font-bold text-white mb-4 leading-tight">
                                    Sistem Keuangan<br>Terintegrasi
                                </h2>
                                <p class="text-green-50 text-lg leading-relaxed">
                                    Kelola keuangan sekolah dengan mudah, aman, dan transparan dalam satu platform
                                    modern.
                                </p>
                            </div>
                ...
                <div class="w-full" data-aos="fade-left" data-aos-duration="1000">
                    <!-- Glass Card -->
                    <div
                        class="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl shadow-green-200/50 border border-white/50 p-8 lg:p-12">

                        <!-- Mobile Logo -->
                        <div class="lg:hidden flex items-center justify-center mb-8" data-aos="zoom-in">
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg shadow-green-500/50">
                        ...
                        <!-- Messages -->
                        @if ($errors->any())
                            <div class="mb-6 bg-red-50/80 backdrop-blur-sm border border-red-200 rounded-2xl p-4"
                                data-aos="fade-in">
                                <div class="flex items-start">
                                    <div
                                        class="w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center mr-3 flex-shrink-0">
                        ...
                        @if (session('success'))
                            <div class="mb-6 bg-green-50/80 backdrop-blur-sm border border-green-200 rounded-2xl p-4"
                                data-aos="fade-in">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <i
                                            class="ri-user-3-line text-gray-400 group-focus-within:text-green-600 transition-colors"></i>
                                    </div>
                                    <input type="email" name="email" required value="{{ old('email') }}"
                                        ...
                                        placeholder="contoh@email.com" autocomplete="email" autofocus>
                                </div>
                            </div>
                            ...
                            <div data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <i
                                            class="ri-key-line text-gray-400 group-focus-within:text-green-600 transition-colors"></i>
                                    </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200" data-aos="fade-up" data-aos-delay="600">
                            <div class="flex flex-col sm:flex-row items-center justify-between text-sm">
                                <div class="flex items-center text-gray-600 mb-3 sm:mb-0">
                                    <i class="ri-github-fill mr-2 text-green-600 text-lg"></i>
                                    <span>
                                        Dibuat oleh
                                        <a href="https://github.com/dms-euro" target="_blank"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-600">Status: <span
                                            class="text-green-600 font-semibold">Online</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
